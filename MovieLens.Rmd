...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{title-image.png}
  \label{fig:my_image}
\end{figure}
...
An alternative approach worth considering is the application of Matrix Factorization techniques, such as Singular Value Decomposition (SVD) or Non-negative Matrix Factorization (NMF), to enhance our prediction model and potentially achieve a further reduction of the RMSE.