...
\begin{figure}[b]
  \centering
  \includegraphics[width=0.5\textwidth]{movielens-cover.png}
...
```{r, echo=FALSE, fig.align="center", fig.cap = "RMSE vs VMax", fig.width=4, fig.height=2}
...
```{r, echo=FALSE, fig.align="center", fig.cap = "RMSE vs VMin", fig.width=4, fig.height=2}
...
The data analysis indicated that ratings are primarily influenced by movieId, followed by userId, genres, year, and surprisingly, timestamp year. Notably, I conducted this analysis on a work laptop with limited computing resources (primarily intended for Office applications) but still managed to attain a relatively low RMSE.
