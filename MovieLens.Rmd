...
```{r, echo=FALSE}
# To increase the speed of the rendering, we only run the setup and the "MovieLens" code separately, and use the variables stored in the global environment. This also allows to reduce the size of the Rmd file by moving as much code as possible to the R file.
